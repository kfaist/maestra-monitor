        ...
        {onOpenWizard && (
          ...
          >
            ...
            <div style={{ flex: 1, textAlign: 'left' }}>
              <div style={{ fontSize: 13, fontWeight: 700, letterSpacing: '0.08em', color: '#00d4ff', textTransform: 'uppercase' as const }}>TD Entity Creation Wizard</div>
              <div style={{ fontSize: 10, color: 'rgba(255,255,255,0.45)', marginTop: 2 }}>Connect a TouchDesigner node to an open slot</div>
            </div>
          </button>
        )}
