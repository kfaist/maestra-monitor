...
export function createInitialSlots(): FleetSlot[] {
  return [
    ...
    // Card 4: Open slot — for another Currents artist
    {
      id: 'slot_4',
      label: 'Open Slot',
      entity_id: '',
      ...
      nodeRole: undefined,
      stateSchema: {},
      suggestion: { title: 'Connect a Node', desc: 'Drop the Maestra TOX into another TD project and connect.', tag: 'td' as const, tagLabel: 'TouchDesigner' },
      _frameTimes: [],
      _fpsSmooth: null,
    },
    // Card 5: Open slot
    {
      ...
      nodeRole: undefined,
      stateSchema: {},
      suggestion: { title: 'Audio / OSC Source', desc: 'Connect Max/MSP, Ableton, or any OSC-capable tool.', tag: 'osc' as const, tagLabel: 'OSC' },
      _frameTimes: [],
      _fpsSmooth: null,
    },
    // Card 6: Open slot
    {
      ...
      nodeRole: undefined,
      stateSchema: {},
      suggestion: { title: 'Sensor / Arduino', desc: 'Connect Arduino, ESP32, Raspberry Pi, or any sensor node.', tag: 'arduino' as const, tagLabel: 'Hardware' },
      _frameTimes: [],
      _fpsSmooth: null,
    },
