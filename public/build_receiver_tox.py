...
#
# OR with a specific entity slug (generated by the monitor wizard):
#   _E='MyEntitySlug'; import urllib.request; exec(urllib.request.urlopen('https://maestra-monitor-production.up.railway.app/build_receiver_tox.py').read().decode())
#
...
# Accept entity slug from caller if provided, otherwise use default
try:
    _ENTITY_SLUG = _E
    print('[TOX] Entity slug from wizard: ' + _ENTITY_SLUG)
except NameError:
    _ENTITY_SLUG = 'KFaist_Shapeshifters'
    print('[TOX] Using default entity: ' + _ENTITY_SLUG)
...
page.appendStr('Entityid', label='Entity ID')[0].default = _ENTITY_SLUG
...
# Set initial values
comp.par.Entityid = _ENTITY_SLUG
